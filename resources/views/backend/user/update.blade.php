			...
			<div class="x_panel">
				<div class="x_content">
					{{ Form::open(['url' => $url, 'method' => $method,'class' => 'form-horizontal form-label-left']) }}
						...
						<div class="form-group">
							<label class="control-label col-sm-3 col-xs-12">Unit Usaha: </label>
							<div class="col-sm-5 col-xs-12">
								{{
								Form::select(
									'id_unit',
									['1' => 'Kampus Masjid Agung', 
									'2' => 'Kampus Simpang Kawat 1',
									'3' => 'Kampus Simpang Kawat 2',
									'99' => 'YYS ALFALAH'],
									$id_unit,
									array(
										'class' => 'form-control',
